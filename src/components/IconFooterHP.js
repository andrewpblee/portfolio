    ...
    <myContext.Consumer>
      {context => (
        <div className="iconfooter">
          <a
            href={"https://github.com/andrewpblee"}
            style={{ textDecoration: "none", color: "#2b2d42" }}
          >
            <svg
              viewBox="0 0 128 128"
              className={`github-icon-${context.toggleState}`}
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <a
            href="https://www.linkedin.com/in/andrewpblee/"
            target="_blank"
            rel="noreferrer"
            style={{ textDecoration: "none", color: "#2b2d42" }}
          >
          ...
          <a
            href="mailto:hey@andrewpblee.com?subject=Hi!"
            rel="noreferrer"
            style={{ textDecoration: "none", color: "#2b2d42" }}
          >
            <svg
